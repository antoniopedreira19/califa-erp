...
export default async function ContasBancariasPage() {
  ...
  // Uma query só: a lista de empresas existia apenas para alimentar o
  // select "Empresa *" do cadastro, que saiu (09/09/2026).
  ...
  return (
    <div className="space-y-6">
      ...
      <ContasBancariasList contas={contas} canEdit={canEdit} />
    </div>
  );
}
