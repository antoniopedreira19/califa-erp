...
export default async function AvulsaDetalhesPage({
  ...
  const contaParaDrawer: ContaAvulsa = {
    ...
    regional_id: c.regional_id as string,
    ...
    parcela_numero: (c.parcela_numero as number | null) ?? 1,
    parcela_total: (c.parcela_total as number | null) ?? 1,
    parcela_de_avulsa_id: (c.parcela_de_avulsa_id as string | null) ?? null,
